# :pencil: :computer: Desmistificando CSS Modules com React

O objetivo deste repositório é clarear o entendimento e uso de CSS Modules e sua implementação num projeto JavaScript com Webpack de forma geral.

Além de tudo, com o estudo teremos a base para um projeto React e CSS Modules, e com suporte para SASS.

---

## Introdução

Um problema comum de grandes projetos é manter o CSS de uma maneira escalável e sem efeitos colateráis. Pensando nisso, e tomando proveito da ideia de componentes e modularização, surgiram algumas ideias para manter o CSS dentro de um escopo. Escopo dos componentes em questão.
...
Abra uma issue e vamos discutir o problema ;)
